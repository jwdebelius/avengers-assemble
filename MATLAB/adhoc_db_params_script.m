...
switch primer_set_name
    ...
    case 'V4'
        ...
        DB_kmer_len = 240;
    case 'optivag'
        % Optivag database params
        primers_seq{1,1} = 'AGAGTTTGATCCTGGCTCAG';
        primers_seq{1,2} = 'ATTACCGCGGCTGCTGG';
        primers_seq{2,1} = 'CCTACGGGNGGCWGCAG';
        primers_seq{2,2} = 'GACTACHVGGGTATCTAATCC';
